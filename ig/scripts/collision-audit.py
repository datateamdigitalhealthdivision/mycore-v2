...
STREAMS = {
    'resources-legacy-migrated': ROOT / 'input' / 'resources-legacy-migrated',
    'resources-forge': ROOT / 'input' / 'resources-forge',
    'resources-terminology': ROOT / 'input' / 'resources-terminology',
    'fsh-generated': ROOT / 'fsh-generated' / 'resources',
}
...
def main():
    ...
    print('Collision audit passed: no duplicate resource ids or canonical urls across authoring streams.')
